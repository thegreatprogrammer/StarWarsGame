...
public: 
    ...
    //Constructor
    naveSith(int _x, int _y, int _corazon, int _vidas);
    int X(){ return x; }
    int Y(){ return y; }
...
naveSith::naveSith(int _x, int _y, int _corazon, int _vidas){
    x = _x;
    y = _y; 
    corazon = _corazon;  
    vidas = _vidas;            
